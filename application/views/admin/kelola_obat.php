    ...
    <div class="container spad">
    	<div class="col-6 rounded mx-auto p-5" style="background-color: white">
    		...
    		<form action="<?php echo site_url('admin/input_obat/'.($newid['id_obat']+1)); ?>" method="post">
    			<div class="form-group row">
    				<div class="col-sm-4">
						<label for="input_idobat">Id Obat</label>
					</div>
					<div class="col-sm-8 ml-auto">
						<input class="form-control form-control-sm" type="text" id="input_idobat" name="id_obat" value="<?php echo $newid['id_obat']+1; ?>" disabled>
					</div>
    			</div>
    			<div class="form-group row">
    				<div class="col-sm-4">
